...
- [Blockwise Self-Supervised Learning at Scale](https://arxiv.org/abs/2302.01647). [tweet](https://arxiv.org/abs/2302.01647).
  - [Hebbian Deep Learning Without Feedback](https://openreview.net/forum?id=8gd4M-_Rj1), `iclr2023`.
- [SMORE: Knowledge Graph Completion and Multi-hop Reasoning in Massive Knowledge Graphs](https://github.com/google-research/smore), Nov. 1 2021. [github](https://github.com/google-research/smore).
- [The Language Interpretability Tool: Extensible, Interactive Visualizations and Analysis for NLP Models](https://arxiv.org/pdf/2008.05122.pdf), Aug. 12 2020.
- [Cut your Losses with Squentropy](https://arxiv.org/pdf/2302.03952.pdf), Feb. 8 2023.
- [Algorithmic Collective Action in Machine Learning](https://arxiv.org/pdf/2302.04262.pdf), Feb. 8 2023.
- [Scaling Vision Transformers to 22 Billion Parameters](https://arxiv.org/pdf/2302.05442.pdf), Feb. 10 2023. [tweet](https://twitter.com/_willfalcon/status/1626954282607030272).
- [KDEformer: Accelerating Transformers via Kernel Density Estimation](https://arxiv.org/pdf/2302.02451.pdf), Feb. 5 2023. [tweet](https://twitter.com/aminkarbasi/status/1626998255258324992). `acceleration`.
...
- [Imbalanced-XGBoost: leveraging weighted and focal loss for binary-imbalanced classification with XGBoost](https://arxiv.org/pdf/1908.01672.pdf), 2019.
- [Array Programming with NumPy](https://arxiv.org/pdf/2006.10256.pdf), Jun. 18 2020.
- [SciPy 1.0—Fundamental Algorithms for Scientific Computing in Python](https://arxiv.org/pdf/1907.10121.pdf), Jul. 23 2019.
- [Scikit-learn: Machine Learning in Python](https://arxiv.org/pdf/1201.0490.pdf), Jun. 5 2018.
- [Hyena Hierarchy: Towards Larger Convolutional Language Models](https://arxiv.org/pdf/2302.10866.pdf), Feb. 21 2023. `Yoshua Bengio` `Chris Re`.
- [Awesome Transformeres](https://github.com/abacaj/awesome-transformers), A curated list of awesome transformer models.
- [tweet: Recently, Karpathy tweeted that *increasing* the size of his matmul made it run faster. But... why?](https://twitter.com/cHHillee/status/1630274804795445248). `must read`.
- [tweet: I built a personal chatbot from my personal corpus](https://twitter.com/thesephist/status/1629272600156176386). `product by chatGPT`
- [Tweet: FLANv2 dataset is available on Hugging Face!](https://twitter.com/_philschmid/status/1628790585866825728), Mar. 1 2023. `instruction-tuning`.
- [Tweet: Modular Deep Learning Survey](https://twitter.com/seb_ruder/status/1628721434162765827), Mar. 1 2023. [paper](https://arxiv.org/abs/2302.11529).

### Active learning

- [Investigating Multi-source Active Learning for Natural Language Inference](https://arxiv.org/pdf/2302.06976.pdf), Feb. 14 2023.
  - _"reveal that uncertainty-based strategies perform poorly due to the acquisition of collective outliers, i.e. hard-to-learn instances that hamper learning and generalization"_
  - _"we find that collective outliers vary in form between sources, and show that hard-to-learn data is not always categorically harmful."_
  - [Dataset cartography](https://github.com/allenai/cartography), `visualization`.

### Visualization

- [Visualizing Data using t-SNE](https://computo.sfds.asso.fr/published-paper-tsne/), published Aug. 11 2008, modified Feb. 16 2023.
...
- [Toolformer: Language Models Can Teach Themselves to Use Tools](https://arxiv.org/abs/2302.04761), Feb. 9 2023. [tweet](https://twitter.com/timo_schick/status/1624058382142345216).
  - [Behavior Cloned Transformers are Neurosymbolic Reasoners](https://arxiv.org/abs/2210.07382), `eacl2023`.
- [A Categorical Archive of ChatGPT Failures](https://arxiv.org/abs/2302.03494), Feb. 6 2023.
- [Blogpost: Emergent Deception and Emergent Optimization](https://bounded-regret.ghost.io/emergent-deception-optimization/), Feb. 19 2023. Jacob Steinhardt. [tweet](https://twitter.com/JacobSteinhardt/status/1627713082717011968).

#### Finetuning

- [Downstream Datasets Make Surprisingly Good Pretraining Corpora](https://arxiv.org/abs/2209.14389), Sep. 28 2022.
- [Evaluating Self-Supervised Learning via Risk Decomposition](https://arxiv.org/pdf/2302.03068.pdf), Feb. 6 2023.
...
- [AI's Linux Moment: An Open-Source AI Model Love Note](https://hazyresearch.stanford.edu/blog/2023-01-30-ai-linux), Jan. 30 2023. Chris Re.
- [Simple Long Convolutions for Sequence Modeling](https://hazyresearch.stanford.edu/blog/2023-02-15-long-convs), Feb. 15 2023.

### Others

- [Tweet: 5 main ideas/components that make NeRFs so effective](https://twitter.com/cwolferesearch/status/1620155302674055169).
- [Tweet: Hippocampal spatial representations exhibit a hyperbolic geometry that expands with experience](https://twitter.com/hiallen72/status/1626428982500663297), Feb. 17 2023.
