...
- [Toward a ‘Standard Model’ of Machine Learning](http://zhiting.ucsd.edu/data/hu2022standard.pdf), `hdsr2022`, havard data science review.
- [A Note on "Assessing Generalization of SGD via Disagreement"](https://openreview.net/forum?id=oRP8urZ8Fx), `tmlr2022`, [tweet](https://twitter.com/BlackHC/status/1591038538232963072?cn=ZmxleGlibGVfcmVjcw%3D%3D&refsrc=email).
- [Do Bayesian Neural Networks Need To Be Fully Stochastic?](https://arxiv.org/abs/2211.06291), Nov. 11 2022, `BayesianDL`.
- [Interactive Visual Feature Search](https://arxiv.org/pdf/2211.15060.pdf), Nov. 28 2022. `interactive interpretability` `visualization`
- [Implications of Model Indeterminacy for Explanations of Automated Decisions](https://openreview.net/pdf?id=LzbrVf-l0Xq), `nips2022`. `interpretability`

---

### Representation learning: methods and theories
...
- [A Theoretical Study of Inductive Biases in Contrastive Learning](https://arxiv.org/pdf/2211.14699.pdf), Nov. 27 2022.
...
- [Inverse scaling can become U-shaped](https://arxiv.org/abs/2211.02011), Nov. 3 2022.
